#!/bin/bash
echo "Donald Trump:
Elon! Great to see you. You're doing fantastic things—tremendous, really. Space, cars, Twitter—nobody's doing it like you."

echo "Elon Musk:
Thanks, Donald. Good to see you too. You’ve definitely left your mark—big headlines, big moves."
