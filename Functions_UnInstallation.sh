...
then #Enter into Loop
    echo "MySQL is already Un Installed..." #Prints this messages on Screen
else #Checks If Exit code != Zero, No
    echo "MYSQL is Not installed.." #Prints this messages on Screen
...
if [ $? -eq 0 ] #Checks If Exit code equls to Zero, Yes
then #Enter into Loop
    echo "Nginx is already Un Installed..." #Prints this messages on Screen
    else #Checks If Exit code != Zero, No
    echo "Nginx is Uninstalled.." #Prints this messages on Screen
...
if [ $? -eq 0 ] #Checks If Exit code equls to Zero, Yes
then #Enter into Loop
    echo "Python is Un Installed..." #Prints this messages on Screen
else #Checks If Exit code != Zero, No
    echo "Python is uninstalled Going to install.." #Prints this messages on Screen
...
if [ $? -eq 0 ] #Checks If Exit code equls to Zero, Yes
then #Enter into Loop
    echo "Node JS is Un Installed..." #Prints this messages on Screen
else #Checks If Exit code != Zero, No
